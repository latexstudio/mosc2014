...
\begin{tikzpicture}[node distance = 2cm, auto]
  ...
  % \node [cloud, right of=init] (system) {system};
    \node [block,  fill=red!50!green!80!blue!100,  above of=AOSP, node distance=2cm] (franco) {Franco gombak kernel};
    \node [block,  fill=red!50!green!80!blue!100,  below of=AOSP, node distance=2cm] (ampang) {Ampang kernel};
    \node [block,  fill=red!50!green!80!blue!100,  right of=AOSP, node distance=2cm] (hellscore) {Hellscore kernel};
    \node [block,  fill=red!50!green!80!blue!100,  left of=AOSP, node distance=2cm] (semaphore) {Semaphore kernel};
    \node [block, fill=red!80!green!80!blue!100,  right of=hellscore, node distance=2cm] (zulfa) {Zulfa kernel};
    \node [block, fill=red!80!green!80!blue!100,  left of=semaphore, node distance=2cm] (pandan) {Pandan kernel};
